                                        ...
                                        <el-row>
                                            <el-col :span="8">
                                                <div class="jux chartBlock" draggable="true">
                                                    <img src="../assets/compPatterns/jux1.png" alt="">
                                                    <span class="title-chart">repetition</span>
                                                </div>
                                            </el-col>
                                            <el-col :span="8">
                                                <div class="jux chartBlock" draggable="true">
                                                    <img src="../assets/compPatterns/jux2.png" alt="">
                                                    <span class="title-chart">mirror</span>
                                                </div>
                                            </el-col>
                                            <el-col :span="8">
                                                <div class="jux chartBlock" draggable="true">
                                                    <img src="../assets/compPatterns/jux3.png" alt="">
                                                    <span class="title-chart">stack</span>
                                                </div>
                                            </el-col>
                                        </el-row>
                                    </div>
                                        ...
                                        <el-row>
                                            <el-col :span="6">
                                                <div class="over chartBlock" draggable="true">
                                                    <img src="../assets/compPatterns/over1.png" alt="">
                                                    <span class="title-chart">co-axis</span>
                                                </div>
                                            </el-col>
                                            <el-col :span="6">
                                                <div class="over chartBlock" draggable="true">
                                                    <img src="../assets/compPatterns/over2.png" alt="">
                                                    <span class="title-chart">coordinate</span>
                                                </div>
                                            </el-col>
                                            <el-col :span="6">
                                                <div class="over chartBlock" draggable="true">
                                                    <img src="../assets/compPatterns/over3.png" alt="">
                                                    <span class="title-chart">annotation</span>
                                                </div>
                                            </el-col>
                                            <el-col :span="6">
                                                <div class="over chartBlock" draggable="true">
                                                    <img src="../assets/compPatterns/over4.png" alt="">
                                                    <span class="title-chart">large panel</span>
                                                </div>
                                            </el-col>
                                        </el-row>
                                    </div>
                                ...
                                <el-col :span="3">
                                    <div class="grid-content nest-bg" >
                                        ...
                                        <el-row>
                                            <el-col :span="24">
                                                <div class="over chartBlock" draggable="true">
                                                    <img src="../assets/compPatterns/nest.png" alt="">
                                                    <span class="title-chart">nesting</span>
                                                </div>
                                            </el-col>
                                        </el-row>
                                    </div>
